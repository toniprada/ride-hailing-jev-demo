...
const names={commuting:'Work or study',business:'Professional activity',leisure:'Leisure or social',visitor_activity:'Visitor activity',personal_errand:'Personal errand or appointment',transport_connection:'Airport or intercity transfer'};
