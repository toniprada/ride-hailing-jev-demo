...
const names={commuting:'Commuting',business:'Business',leisure:'Leisure or social',event_attendance:'Event attendance',visitor_activity:'Attraction',other:'Other',transport_connection:'Airport or intercity transfer'};
