...
const names={commuting:'Commuting',business:'Business',leisure:'Leisure or social',dining_nightlife:'Dining or nightlife',event_attendance:'Event attendance',visitor_activity:'Visitor activity',shopping:'Shopping',other:'Other',transport_connection:'Airport or intercity transfer'};
